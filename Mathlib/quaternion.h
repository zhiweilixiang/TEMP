...
public:
    ...
    */
    ...
    {
        if (fabs((double)v.x - (double)x) > tol)      return false;
        else if (fabs((double)v.y - (double)y) > tol) return false;
        else if (fabs((double)v.z - (double)z) > tol) return false;
        else if (fabs((double)v.w - (double)w) > tol) return false;
        return true;
    };
