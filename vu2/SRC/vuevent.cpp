...
int VuPositionUpdateEvent::Encode(VU_BYTE** buf){
	...
	memcpy(*buf, &sdx_, sizeof(sdx_)); *buf += sizeof(sdx_);
	memcpy(*buf, &sdy_, sizeof(sdy_)); *buf += sizeof(sdy_);
	memcpy(*buf, &sdz_, sizeof(sdz_)); *buf += sizeof(sdz_);
	...
	memcpy(*buf, &yc_, sizeof(yc_));  *buf += sizeof(yc_);
	memcpy(*buf, &pc_, sizeof(pc_));  *buf += sizeof(pc_);
	memcpy(*buf, &rc_, sizeof(rc_));  *buf += sizeof(rc_);
	return (LocalSize());
}
