...
public:
	...
	virtual VU_BOOL Test(VuEntity *ent){ return ent->IsGame(); }
	virtual VU_BOOL RemoveTest(VuEntity *ent){ return ent->IsGame(); }
	virtual int Compare(VuEntity *ent1, VuEntity *ent2){ return compareEnts(ent1, ent2); }
	virtual VuFilter *Copy(){ return new VuGameFilter(this); }
protected:
...
public:
	...
	virtual VU_BOOL Test(VuEntity* ent){ return ent->IsTarget(); }
	virtual VU_BOOL RemoveTest(VuEntity* ent){ return ent->IsTarget(); }
	virtual int Compare(VuEntity* ent1, VuEntity* ent2){ return compareEnts(ent1, ent2); }
	virtual VuFilter* Copy(){ return new VuTargetFilter(this); }
