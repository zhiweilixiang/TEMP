...
public:
	...
	~VuBin(){
		VuDeReferenceEntity((VuEntity *)e);
	}
	...
	/** different */
	bool operator!=(const VuBin &rhs)const{ return !operator==(rhs); }
...
template <class E> bool operator==(const void* le, const VuBin<E> &re){ return ((void*)re.get()) == le; }
