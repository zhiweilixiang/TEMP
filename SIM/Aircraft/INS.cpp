...
void AircraftClass::CalcINSOffset(void)
{
	if(OTWDriver.pCockpitManager && OTWDriver.pCockpitManager->mpIcp)
	{
		...
		float DiffLat = (float)(fabs((double)(OTWDriver.pCockpitManager->mpIcp->StartLat) - (double)(Curlatitude)));
		float DiffLong = (float)(fabs(double(OTWDriver.pCockpitManager->mpIcp->StartLong) - (double)(Curlongitude)));
