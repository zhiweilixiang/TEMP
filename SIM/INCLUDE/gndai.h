...
// I split this into movement classes, ranks, formation & combat classes and use
...
public:
		SimObjectType	*GetAirTargetPtr (void)				{ return airTargetPtr; }
protected:
