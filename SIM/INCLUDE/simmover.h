...
public:
	...
	*/
	...
	virtual void WeaponKeepAlive() { return; };
	...
	//RERUN void SetSwitch (int num, int val) { ShiAssert(num < numSwitches); if (num < numSwitches) { switchData[num] = val; switchChange[num] = TRUE;} }
	void SetSwitch(int num, int val) { if (num < numSwitches) { switchData[num] = val; switchChange[num] = TRUE; } } //RERUN
