...
class FaultClass {
   ...
   public:
       ...
       int	GetFaultCount(void) {return mFaultCount;}
       void	TotalPowerFailure(); // JPO
       void	RandomFailure(); // THW 2003-1120
       int      Breakable (type_FSubSystem id) {return mpFaultData[id].mBreakable;};
       ...
       int	GetMflListCount() { return mLastMfl; };
       void ClearMfl() { mLastMfl = 0; };
       void SetStartTime(VU_TIME time) { mStartTime = time; };
