...
public:
		...
		int GetCurTCNRange() { return mpCurrentTCN[mCurrentTCNSrc].range; };
		int GetCurTCNType() { return mpCurrentTCN[mCurrentTCNSrc].ttype; };
		float GetCurTCNILS() { return mpCurrentTCN[mCurrentTCNSrc].ilsfreq; };
