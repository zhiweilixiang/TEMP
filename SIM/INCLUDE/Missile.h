...
public:
	MissileAuxData() {	psGroundImpact = psMissileKill = psFeatureImpact = psBombImpact = psArmingDelay = psExceedFOV = 0; }
	~MissileAuxData()
	{
...
public:
	...
	int LaunchDelayTime(void) { return auxData->pickleTimeDelay; }
	float GetRuntime(void) { return runTime; }
	
	// RV - Biker - FOV data from missile FMs
	float GetFOVLevel (void) { return auxData->FOVLevel;};
	float GetEXPLevel (void) { return auxData->EXPLevel;};

	// RV - Biker - DLZ max/min from missile FMs
	float GetWEZmax (void) { return auxData->WEZmax;};
	float GetWEZmin (void) { return auxData->WEZmin;};

	//RV - I-Hawk 
	float GetGimbalTrack (void) { return auxData->gimbalTrackFactor; };
	int GetLaunchSound (void) { return auxData->launchSound; };
	...
	int GetSndAim9Growl(void)			{return auxData->sndAim9Growl;};
	int GetSndAim9GrowlLock(void)		{return auxData->sndAim9GrowlLock;};
	int GetSndAim9Uncaged(void)			{return auxData->sndAim9Uncaged;};
	int GetSndAim9EnviroSky(void)		{return auxData->sndAim9EnviroSky;};
	int GetSndAim9EnviroGround(void)	{return auxData->sndAim9EnviroGround;};
private:
