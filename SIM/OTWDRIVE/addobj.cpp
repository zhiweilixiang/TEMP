...
long TeamSimColorList[NUM_TEAMS] = {	(long)0xfffffffe,		// Thunderbird		// White  not quite white so color is steady
										(long)0xff008000,		// US				// Green
										(long)0xffff0000,		// ROK/Shark		// Blue
										(long)0xff3771B2,		// Japan			// Brown
										(long)0xff00ffff,		// China			// Yellow
										(long)0xff00adff,		// Russia/Tiger		// Orange
										(long)0xff0000ff,		// DPRK/Crimson		// Red
										(long)0xff000000 };	// No one			// Black
