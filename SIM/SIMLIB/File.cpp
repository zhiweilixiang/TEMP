...
#ifndef _USE_RES_MGR_ // RERUN, DON'T USE RESMGR

#define FILE_FS_OPEN   fopen
#define FILE_FS_CLOSE  fclose
...
#define FILE_FS_OPEN   RES_FOPEN
#define FILE_FS_CLOSE  RES_FCLOSE
...
int offset, len;
   ...
   fHandle->fptr = FILE_FS_OPEN(fileName, access);
