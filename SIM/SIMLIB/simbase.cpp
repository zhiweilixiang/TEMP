...
{
	// LEON TODO: Need to convert from a local to a remote entity.
}
...
int SimBaseClass::Wake(){
	...
	//ShiAssert (OTWDriver.IsActive()); //RERUN removed because user can exit to main menu when missile gets fired 
