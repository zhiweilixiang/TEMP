...
//RERUN	if (g_bResizeUsesResMgr)
//RERUN		return ResExistFile(file);
...
//RERUN #define fopen       ResFOpen
//RERUN #define fclose      ResFClose
...
int FindCockpit(
	...
	{
		//RERUN restore default cockpit dir. the global var got overwritten in this function...
		sprintf(cockpitFolder, "%s", COCKPIT_DIR);
		sprintf(strCPFile, "%s%s", cockpitFolder, pCPFile); 
		return 0;
	}
