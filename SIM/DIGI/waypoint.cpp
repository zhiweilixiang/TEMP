...
void DigitalBrain::FollowWaypoints(void)
{
   ...
   if (self->curWaypoint == NULL)
   {
	...
	if (isWing && (atcstatus != AtcStatusEnum::noATC))
   ...
   if (self->curWaypoint)
   {
      switch (self->curWaypoint->GetWPAction())
      {
         ...
         case WP_SAD:
...
#else
			 if ((missionType == MissionTypeEnum::AMIS_OCASTRIKE) ||
				 (missionType == MissionTypeEnum::AMIS_INTSTRIKE) ||
				 (missionType == MissionTypeEnum::AMIS_STRIKE) ||
				 (missionType == MissionTypeEnum::AMIS_DEEPSTRIKE)||
				 (missionType == MissionTypeEnum::AMIS_STSTRIKE) ||
				 (missionType == MissionTypeEnum::AMIS_STRATBOMB) )
            ...
            if (missionType == MissionTypeEnum::AMIS_CAS)
            {
