...
//RERUN #define _SI_USE_RES_MGR_ 1
...
void ClipAndDrawCursor(int displayWidth, int displayHeight) {
	...
	else
	{
		...
		pVtx[0].x = (float)CursorDest.left; pVtx[0].y = (float)CursorDest.top; pVtx[0].u = fStartU; pVtx[0].v = fStartV;
		pVtx[0].r = pVtx[0].g = pVtx[0].b = pVtx[0].a = 1.0f;
		pVtx[1].x = (float)CursorDest.right; pVtx[1].y = (float)CursorDest.top; pVtx[1].u = fMaxU; pVtx[1].v = fStartV;
		pVtx[1].r = pVtx[1].g = pVtx[1].b = pVtx[1].a = 1.0f;
		pVtx[2].x = (float)CursorDest.right; pVtx[2].y = (float)CursorDest.bottom; pVtx[2].u = fMaxU; pVtx[2].v = fMaxV;
		pVtx[2].r = pVtx[2].g = pVtx[2].b = pVtx[2].a = 1.0f;
		pVtx[3].x = (float)CursorDest.left; pVtx[3].y = (float)CursorDest.bottom; pVtx[3].u = fStartU; pVtx[3].v = fMaxV;
