...
// Retro_dead 15Jan2004	GUID	joystick;						// unique identifier for which joystick to use
	...
	static const int RAMP_MINUTES = 20; // how long before take off MI increased from 8
	static const int TAXI_MINUTES = 3;  // RERUN Taxi takeoff time
...
//	int ObjectShadingOn (void)								{ return (ObjFlags & DISP_OBJ_SHADING) && TRUE; }
	...
	bool getInfoBar(void) const 							{ return infoBar; }				// Retro 25Dec2003
	bool getSubtitles(void) const							{ return subTitles; }			// Retro 25Dec2003
	bool Get2dTrackIR(void) const 							{ return TrackIR_2d; }			// Retro 27Dec2003
	bool Get3dTrackIR(void) const                           { return TrackIR_3d; }			// Retro 27Dec2003
	bool GetFFB(void) const 								{ return enableFFB; }			// Retro 27Dec2003
	bool GetMouseLook(void) const                           { return enableMouseLook; }		// Retro 28Dec2003
	bool GetTouchBuddy(void) const                          { return enableTouchBuddy; }    // sfr: touch buddy support
	bool GetDrawMirror(void) const                          { return drawMirror; }    // sfr: rear mirror 
...
// Retro_dead 15Jan2004	GUID GetJoystick (void)									{ return joystick; }
	...
	void SetTouchBuddy(bool onOff)                          { enableTouchBuddy = onOff; } //sfr: touch buddy support
	void SetDrawMirror(bool onOff)							{ drawMirror = onOff; } // sfr: rear view mirror
