...
// OW
...
#else
	//RERUN context.DrawPrimitive(MPR_PRM_TRIFAN, MPR_VI_COLOR | MPR_VI_TEXTURE,(unsigned short)(nextOut - outList), (MPRVtxTexClr_t **) outList);
	...
	context.DrawPrimitive(MPR_PRM_TRIFAN, MPR_VI_COLOR | MPR_VI_TEXTURE, vDummyVector);
#endif
}
