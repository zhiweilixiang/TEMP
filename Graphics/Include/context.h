...
public:
	...
	//RERUN void DrawPrimitive(int type, WORD VtxInfo, WORD Count, MPRVtxTexClr_t **data, bool terrain=false);
	void DrawPrimitive(int nPrimType, WORD VtxInfo, std::vector<MPRVtxTexClr_t>& pData, bool terrain = false);//RERUN
