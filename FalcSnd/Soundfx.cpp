...
{ "biggun1.wav",    0,0, 0, 10000000.0F,0.0F,-10000.0F,10000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,FX_SOUND_GROUP,0,0},
...
{ "engheli.wav",    0,0, 0, 10000000.0F,0.0F,-6000.0F,10000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_FREQ|SFX_FLAGS_3D|SFX_FLAGS_HIGH,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
{ "eject.wav",      0,0, 0, 100000.0F,0.0F,-10000.0F,100000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,FX_SOUND_GROUP,0,0},
{ "growl.wav",      0,0, 0, 100000.0F,0.0F,-10000.0F,1000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_FREQ|SFX_FLAGS_HIGH,1.0F,1.0F,SIDEWINDER_SOUND_GROUP,0,0},
{ "growlock.wav",   0,0, 0, 4000000.0F,0.0F,-10000.0F,4000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_FREQ,1.0F,1.0F,SIDEWINDER_SOUND_GROUP,0,0},
...
{ "prop.wav",       0,0, 0, 500000.0F,0.0F,-10000.0F,500000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_FREQ|SFX_FLAGS_3D,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
...
{ "vulstart.wav",   0,0, 0, 400000000.0F,0.0F,-3500.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_FLAGS_3D,1.0F,1.0F,COCKPIT_SOUND_GROUP,0,0},
{ "vulloop.wav",    0,0, 0, 400000000.0F,0.0F,-4000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_3D,1.0F,1.0F,COCKPIT_SOUND_GROUP,0,0},
...
{ "enginea.wav",    0,0, 0, 2500000000.0F,0.0F,-100.0F,2500000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_FREQ|SFX_FLAGS_3D|SFX_FLAGS_HIGH,1.0F,1.0F,ENGINE_SOUND_GROUP,0,500},
...
{ "f16int.wav",     0,0, 0, 2500000000.0F,0.0F,-10000.0F,2500000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_FREQ|SFX_FLAGS_3D|SFX_FLAGS_HIGH,1.0F,1.0F,ENGINE_SOUND_GROUP,0,500},
...
{ "touchdn.wav",    0,0, 0, 10000000.0F,0.0F,-10000.0F,10000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
...
{ "flaps.wav",      0,0, 0, 500000.0F,0.0F,-10000.0F,500000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_FLAGS_3D,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
{ "mcgun.wav",      0,0, 0, 5000000.0F,0.0F,-10000.0F,5000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,FX_SOUND_GROUP,0,0},
...
{ "warning.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_FLAGS_VMS,1.0F,1.0F,COCKPIT_SOUND_GROUP,0,0},
...
{ "None.wav",       0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_FLAGS_VMS,1.0F,1.0F,RWR_SOUND_GROUP,0,0},
{ "iff.wav",        0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_FLAGS_VMS,1.0F,1.0F,RWR_SOUND_GROUP,0,0},
{ "vulloope.wav",   0,0, 0, 5000000.0F,0.0F,-10000.0F,5000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,COCKPIT_SOUND_GROUP,0,0},
{ "vulende.wav",    0,0, 0, 5000000.0F,0.0F,-10000.0F,5000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,COCKPIT_SOUND_GROUP,0,0},
{ "twi\\a50.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,2,8},
{ "twi\\chaparal.wav",            0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,0},
{ "twi\\f5.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,2},
{ "twi\\f22.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,6},
{ "twi\\2s6.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,4},
{ "twi\\adats.wav", 0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,6},
{ "twi\\ah66.wav",  0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,7},
{ "twi\\av8b.wav",  0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,8},
{ "twi\\e2c.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,1},
{ "twi\\e3.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,2},
{ "twi\\f4.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,1},
{ "twi\\f14.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,3},
{ "twi\\f15.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,4},
...
{ "twi\\hercules.wav",  0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,7},
{ "twi\\j5.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,2,7},
...
{ "twi\\launch.wav",              0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,0,0},
{ "twi\\lav_adv.wav",             0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,9},
{ "twi\\patriot.wav",             0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0,
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,8},
{ "twi\\sa2.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,2},
{ "twi\\sa3.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,3},
{ "twi\\sa4.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,4},
{ "twi\\sa5.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,5},
{ "twi\\sa6.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,6},
{ "twi\\sa8.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,8},
{ "twi\\sa9.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,9},
{ "twi\\sa10.wav",  0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,1},
{ "twi\\sa13.wav",  0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,3,7},
{ "twi\\slotback.wav",            0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,2,1},
...
{ "diveloop.wav",   0,0, 0, 50000000.0F,0.0F,-10000.0F,50000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,FX_SOUND_GROUP,0,0},
{ "fireloop.wav",   0,0, 0, 50000000.0F,-500.0F,-10000.0F,50000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_3D|SFX_FLAGS_FREQ,1.0F,1.0F,FX_SOUND_GROUP,0,0},
...
{ "brakloop.wav",   0,0, 0, 5000000.0F,0.0F,-10000.0F,5000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
{ "brakstrt.wav",   0,0, 0, 5000000.0F,0.0F,-10000.0F,5000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
{ "brakwind.wav",   0,0, 0, 5000000.0F,0.0F,-10000.0F,5000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_POS_EXTERN|SFX_FLAGS_3D|SFX_FLAGS_FREQ,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
...
{ "twi\\Barlock.wav",             0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,9},
{ "twi\\Firecan.wav",             0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,3},
{ "twi\\flatface.wav",            0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,1},
{ "twi\\longtrak.wav",            0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,5},
{ "twi\\lowblow.wav",             0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,6},
...
{ "twi\\MSQ48.wav", 0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,3},
{ "twi\\MSQ50.wav", 0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,4},
{ "twi\\spoonrst.wav",            0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,7},
{ "twi\\Tps63.wav", 0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,10},
{ "twi\\f16.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,6,5},
{ "twi\\spy1a.wav", 0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,5,5},
{ "twi\\gundish.wav",             0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,1,8},
{ "twi\\amraam.wav",              0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,8,1},
{ "twi\\phoenix.wav",             0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,RWR_SOUND_GROUP,8,2},
{ "cockpit\\lspdtone.wav",        0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED,1.0F,1.0F,COCKPIT_SOUND_GROUP,0,0},
{ "tlscrape.wav",   0,0, 0, 4000000.0F,0.0F,-10000.0F,4000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_3D|SFX_FLAGS_FREQ,1.0F,1.0F,COCKPIT_SOUND_GROUP,0,0},
{ "rumble.wav",     0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_3D|SFX_FLAGS_FREQ,1.0F,1.0F,FX_SOUND_GROUP,0,0},
{ "rumbshrt.wav",   0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_FREQ,1.0F,1.0F,FX_SOUND_GROUP,0,0},
{ "thump2.wav",     0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_FLAGS_3D|SFX_FLAGS_FREQ,1.0F,1.0F,FX_SOUND_GROUP,0,0},
...
{ "hit1.wav",       0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_FLAGS_3D,1.0F,1.0F,FX_SOUND_GROUP,0,0},
...
{ "c130.wav",       0,0, 0, 400000000.0F,0.0F,-10000.0F,400000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_FREQ|SFX_FLAGS_3D|SFX_FLAGS_HIGH,1.0F,1.0F,ENGINE_SOUND_GROUP,0,0},
...
{ "nocage.wav",      0,0, 0, 1000000.0F,0.0F,-10000.0F,1000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_FREQ|SFX_FLAGS_3D|SFX_FLAGS_HIGH,1.0F,1.0F,SIDEWINDER_SOUND_GROUP,0,0},
//MI EWS sounds
...
{ "thunder.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,10000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_3D,1.0F,1.0F,FX_SOUND_GROUP,0,0, 10000},
//RERUN { "rainint.wav",    0,0, 0, 40000.0F,0.0F,-10000.0F,10000000.0F, 0, 0,
{ "rainint.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,10000000.0F, 0, 0,
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_FREQ|SFX_FLAGS_3D,1.0F,1.0F,FX_SOUND_GROUP,0,0, 0},
//RERUN { "rainext.wav",    0,0, 0, 40000.0F,0.0F,-10000.0F,10000000.0F, 0, 0,
{ "rainext.wav",    0,0, 0, 400000000.0F,0.0F,-10000.0F,10000000.0F, 0, 0,
    SFX_POSITIONAL|SFX_POS_EXTERN|SFX_FLAGS_FREQ|SFX_POS_LOOPED|SFX_FLAGS_3D,1.0F,1.0F,FX_SOUND_GROUP,0,0, 0},
{ "groan1.wav",    0,0, 0, 40000.0F,0.0F,-10000.0F,10000000.0F, 0, 0, 
    SFX_POSITIONAL|SFX_POS_LOOPED|SFX_FLAGS_FREQ,1.0F,1.0F,FX_SOUND_GROUP,0,0, 0},
