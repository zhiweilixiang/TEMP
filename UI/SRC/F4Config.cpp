...
char g_strWorldName[0x40] = {"FREEFALCON"};
char g_strScrollUpFunction[0x40]="FOVDecrease";		//Wombat778 11-16-2003 swapped FOVIncrease and Decrease.  It was backwards 10-07-2003
...
bool g_bUseNew3dpit = true; //ATARIBABY Use new 3dpit code - needs new 3d pit model. RERUN set to true
bool g_bStartIn3Dpit = true;  // Cobra - start in 3D cockpit, RERUN set to true
...
//	strcat(strDir, "FalconBMSServer.cfg");
	strcat(strDir, "FreefalconServer.cfg");
	file = fopen(strDir, "r");
