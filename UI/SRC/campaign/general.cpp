...
BOOL DisplayTarget(MissionTypeEnum MissType)
{
	switch(MissType)
	{
...
void GetMissionTarget(Package curpackage,Flight curflight,_TCHAR Buffer[])
{
	...
	if(((curflight) && (curflight->GetUnitMission() != MissionTypeEnum::AMIS_ABORT)) || (!curflight))
	{
		ent=FindEntity(curpackage->GetMissionRequest()->targetID);
		
		if(ent && DisplayTarget(static_cast<MissionTypeEnum>(curflight->GetUnitMission())))
		{
			if (ent->IsObjective())
	...
	if(win)
	{
		...
		if(curflight && curpackage && planecount)
		{
			...
			if(txt)
			{
				...
				_tcscat(Buffer,": ");
				_tcscat(Buffer,MissStr[(uchar)curflight->GetUnitMission()]);
				txt->SetText(Buffer);
			}
			...
			if (curpackage->GetMissionRequest()){
				_tcscpy(Task,MissStr[(uchar)curpackage->GetMissionRequest()->mission]);
			}

			// Get Mission string

			if((curflight != NULL) && (curflight->GetUnitMission() != MissionTypeEnum::AMIS_ABORT))
			{
...
char strTmp[80];
strTmp[0x0] = 'D'; strTmp[0x1] = 'i'; strTmp[0x2] = 'r'; strTmp[0x3] = 'e'; strTmp[0x4] = 'c'; strTmp[0x5] = 't'; strTmp[0x6] = 'X'; strTmp[0x7] = ' ';
strTmp[0x8] = '7'; strTmp[0x9] = ' '; strTmp[0xa] = 'P'; strTmp[0xb] = 'o'; strTmp[0xc] = 'r'; strTmp[0xd] = 't'; strTmp[0xe] = '\0';
...
strTmp[0x0] = 'e'; strTmp[0x1] = 'R'; strTmp[0x2] = 'A'; strTmp[0x3] = 'Z'; strTmp[0x4] = 'O'; strTmp[0x5] = 'R'; strTmp[0x6] = '\0';
txt=new C_Text;
txt->Setup(C_DONT_CARE,0);
txt->SetFont(1);
txt->SetFGColor(0xffffff);
...
strTmp[0x0] = 'M'; strTmp[0x1] = 'i'; strTmp[0x2] = 'r'; strTmp[0x3] = 'v'; strTmp[0x4] = '\0';
txt=new C_Text;
txt->Setup(C_DONT_CARE,0);
txt->SetFont(1);
txt->SetFGColor(0xffffff);
...
strTmp[0x0] = 'P'; strTmp[0x1] = 'a'; strTmp[0x2] = 'u'; strTmp[0x3] = 'l'; strTmp[0x4] = '1'; strTmp[0x5] = '2'; strTmp[0x6] = '1'; strTmp[0x7] = '2'; strTmp[0x8] = '\0';
txt=new C_Text;
txt->Setup(C_DONT_CARE,0);
txt->SetFont(1);
txt->SetFGColor(0xffffff);
...
strTmp[0x0] = 'L'; strTmp[0x1] = 'o'; strTmp[0x2] = 'k'; strTmp[0x3] = 'e'; strTmp[0x4] = '\0';
txt=new C_Text;
txt->Setup(C_DONT_CARE,0);
txt->SetFont(1);
txt->SetFGColor(0xffffff);
...
strTmp[0x0] = 'F'; strTmp[0x1] = 'm'; strTmp[0x2] = 'b'; strTmp[0x3] = 'l'; strTmp[0x4] = 's'; strTmp[0x5] = '\0';
txt=new C_Text;
txt->Setup(C_DONT_CARE,0);
txt->SetFont(1);
txt->SetFGColor(0xffffff);
...
strTmp[0x0] = 'L'; strTmp[0x1] = 'a'; strTmp[0x2] = 'w'; strTmp[0x3] = 'n'; strTmp[0x4] = 'd'; strTmp[0x5] = 'a'; strTmp[0x6] = 'r'; strTmp[0x7] = 'd'; strTmp[0x8] = '\0';
txt=new C_Text;
txt->Setup(C_DONT_CARE,0);
txt->SetFont(1);
txt->SetFGColor(0xffffff);
