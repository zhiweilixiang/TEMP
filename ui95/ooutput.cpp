...
O_Output::O_Output(char **stream)
{
	...
	memcpy(&Font_,*stream,sizeof(long));			*stream += sizeof(long);
	memcpy(&ScaleSet_,*stream,sizeof(long));		*stream += sizeof(long);

	memcpy(&FgColor_,*stream,sizeof(COLORREF));		*stream += sizeof(COLORREF);
	memcpy(&BgColor_,*stream,sizeof(COLORREF));		*stream += sizeof(COLORREF);
	memcpy(&Src_,*stream,sizeof(UI95_RECT));		*stream += sizeof(UI95_RECT);
	memcpy(&Dest_,*stream,sizeof(UI95_RECT));		*stream += sizeof(UI95_RECT);
	memcpy(&origx_,*stream,sizeof(long));			*stream += sizeof(long);
	memcpy(&origy_,*stream,sizeof(long));			*stream += sizeof(long);
	...
	memcpy(&_OType_,*stream,sizeof(short));			*stream += sizeof(short);
	memcpy(&animtype_,*stream,sizeof(short));		*stream += sizeof(short);
	memcpy(&frame_,*stream,sizeof(short));			*stream += sizeof(short);
	memcpy(&direction_,*stream,sizeof(short));		*stream += sizeof(short);
	memcpy(&ready_,*stream,sizeof(short));			*stream += sizeof(short);
	memcpy(&fperc_,*stream,sizeof(short));			*stream += sizeof(short);
	memcpy(&bperc_,*stream,sizeof(short));			*stream += sizeof(short);
	memcpy(&LabelLen_,*stream,sizeof(short));		*stream += sizeof(short);
}
...
void O_Output::Save(char **stream)
{
	...
	memcpy(*stream,&Font_,sizeof(long));			*stream += sizeof(long);
	memcpy(*stream,&ScaleSet_,sizeof(long));		*stream += sizeof(long);

	memcpy(*stream,&FgColor_,sizeof(COLORREF));		*stream += sizeof(COLORREF);
	memcpy(*stream,&BgColor_,sizeof(COLORREF));		*stream += sizeof(COLORREF);
	memcpy(*stream,&Src_,sizeof(UI95_RECT));		*stream += sizeof(UI95_RECT);
	memcpy(*stream,&Dest_,sizeof(UI95_RECT));		*stream += sizeof(UI95_RECT);
	memcpy(*stream,&origx_,sizeof(long));			*stream += sizeof(long);
	memcpy(*stream,&origy_,sizeof(long));			*stream += sizeof(long);
	...
	memcpy(*stream,&_OType_,sizeof(short));			*stream += sizeof(short);
	memcpy(*stream,&animtype_,sizeof(short));		*stream += sizeof(short);
	memcpy(*stream,&frame_,sizeof(short));			*stream += sizeof(short);
	memcpy(*stream,&direction_,sizeof(short));		*stream += sizeof(short);
	memcpy(*stream,&ready_,sizeof(short));			*stream += sizeof(short);
	memcpy(*stream,&fperc_,sizeof(short));			*stream += sizeof(short);
	memcpy(*stream,&bperc_,sizeof(short));			*stream += sizeof(short);
	memcpy(*stream,&LabelLen_,sizeof(short));		*stream += sizeof(short);
}
