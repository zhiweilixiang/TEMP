...
class FlightDataClass
{
		public:
				...
				MissionTypeEnum         old_mission;						// Old mission, if we were diverted
...
class MissionEvaluationClass
{
		public:
				...
				MissionTypeEnum     package_mission;
...
class PilotSortClass
{
		public:
				...
				PilotSortClass(PilotDataClass *pilot_ptr)	{ pilot_data = pilot_ptr; next = NULL; };
};
