...
MissionRequestClass::MissionRequestClass (void)
	...
	target_num = 255;
	tot_type = 0;
	mission = MissionTypeEnum::AMIS_NONE;
	priority = 0;
	speed = 0;
	match_strength = 0;
	aircraft = 0;
...
int MissionRequestClass::RequestMission (void)
	{
	if ((mission == MissionTypeEnum::AMIS_NONE) || (priority < 0) || (vs && !GetRoE(who,vs,roe_check)))
		return -1;
...
MissionDataType MissionData [(uchar)MissionTypeEnum::AMIS_OTHER] =
 {	{ (uchar)MissionTypeEnum::AMIS_NONE,		AMIS_TAR_NONE,		0,				MPROF_STANDARD,	TPROF_ATTACK,	TDESC_NONE,	WP_NOTHING,	WP_LAST,		0,		  0,	  0,  0,  0, 0,  0,  0, (uchar)MissionTypeEnum::AMIS_NONE,		0,  0, 0, 0 },
	{ (uchar)MissionTypeEnum::AMIS_BARCAP,		AMIS_TAR_LOCATION,	ARO_CA,			MPROF_HIGH,		TPROF_SEARCH,	TDESC_TTL,	WP_NOTHING,	WP_CAP,			100,	400,	200,  0, 15, 2,  5, 30, (uchar)MissionTypeEnum::AMIS_NONE,	   15, 15, 0, AMIS_ADDAWACS | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_DONT_COORD | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_BARCAP2,		AMIS_TAR_LOCATION,	ARO_CA,			MPROF_HIGH,		TPROF_SEARCH,	TDESC_TTL,	WP_NOTHING,	WP_CAP,			100,	400,	200,  0, 15, 2,  5, 30, (uchar)MissionTypeEnum::AMIS_NONE,	   15, 15, 0, AMIS_ADDAWACS | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_DONT_COORD | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_HAVCAP,		AMIS_TAR_UNIT,		ARO_CA,			MPROF_HIGH,		TPROF_SEARCH,	TDESC_ATA,	WP_ESCORT,	WP_CAP,			100,	400,	300,-60, 60, 2,  5, 30, (uchar)MissionTypeEnum::AMIS_NONE,		1, 15, 0, AMIS_ADDAWACS | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_NO_BREAKPT | AMIS_FLYALWAYS }, //AMIS_EXPECT_DIVERT | removed, don't divert HAVCAPs
	{ (uchar)MissionTypeEnum::AMIS_TARCAP,		AMIS_TAR_LOCATION,	ARO_CA,			MPROF_HIGH,		TPROF_SEARCH,	TDESC_TAO,	WP_NOTHING,	WP_CAP,			100,	300,	200,-60, 15, 2,  5, 30, (uchar)MissionTypeEnum::AMIS_NONE,	   30, 15, 0, AMIS_ADDAWACS | AMIS_HIGHTHREAT | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_RESCAP,		AMIS_TAR_LOCATION,	ARO_CA,			MPROF_HIGH,		TPROF_SEARCH,	TDESC_TAO,	WP_ESCORT,	WP_CAP,			50,		100,	100,  0, 15, 2,  5, 30, (uchar)MissionTypeEnum::AMIS_NONE,	   30, 15, 0, AMIS_ADDAWACS | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_AMBUSHCAP,	AMIS_TAR_LOCATION,	ARO_CA,			MPROF_LOW,		TPROF_SEARCH,	TDESC_TTL,	WP_NOTHING,	WP_CAP,			2,		 10,	  7,  0, 15, 2,  5, 30, (uchar)MissionTypeEnum::AMIS_NONE,	   30, 15, 0, AMIS_ADDAWACS | AMIS_NOTHREAT | AMIS_DONT_COORD | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_SWEEP,		AMIS_TAR_LOCATION,	ARO_CA,			MPROF_HIGH,		TPROF_SWEEP,	TDESC_TTL,	WP_CA,		WP_CA,			100,	400,	200,  0,  0, 4,  5, 30, (uchar)MissionTypeEnum::AMIS_NONE,		1, 30, 0, AMIS_ADDAWACS | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT },
  	{ (uchar)MissionTypeEnum::AMIS_ALERT,		AMIS_TAR_LOCATION,	ARO_CA,			MPROF_LOW,		TPROF_NONE,		TDESC_TAO,	WP_NOTHING,	WP_NOTHING,		0,		 10,	  0,  0,  0, 2,  0, 10, (uchar)MissionTypeEnum::AMIS_NONE,		1,  0, 0, AMIS_NOTHREAT | AMIS_TARGET_ONLY | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_INTERCEPT,	AMIS_TAR_UNIT,		ARO_CA,			MPROF_HIGH,		TPROF_TARGET,	TDESC_TAO,	WP_NOTHING,	WP_INTERCEPT,	100,	400,	200,  0,  0, 2,  0, 20, (uchar)MissionTypeEnum::AMIS_NONE,		0,  0, 0, AMIS_IMMEDIATE | AMIS_ASSIGNED_TAR | AMIS_EXPECT_DIVERT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_ESCORT,		AMIS_TAR_UNIT,		ARO_CA,			MPROF_STANDARD,	TPROF_FLYBY,	TDESC_ATA,	WP_ESCORT,	WP_ESCORT,		50,		600,	200,-60,  0, 2, 10, 20, (uchar)MissionTypeEnum::AMIS_NONE,		1,  0, 0, AMIS_ADDAWACS | AMIS_HIGHTHREAT | AMIS_MATCHSPEED | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
...
// Fixed by M.N. forgot to add the RP5 SEADSTRIKE line...
	{ (uchar)MissionTypeEnum::AMIS_SEADSTRIKE,	AMIS_TAR_UNIT,		ARO_SEAD,		MPROF_STANDARD,	TPROF_ATTACK,	TDESC_ATA,	WP_SEAD,	WP_SEAD,		20,		120,	 40,  0,  0, 4, 10, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,255, 0, AMIS_ADDECM | AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDBARCAP | AMIS_MATCHSPEED | AMIS_HIGHTHREAT | AMIS_NO_TARGETABORT },
	{ (uchar)MissionTypeEnum::AMIS_SEADESCORT,	AMIS_TAR_UNIT,		ARO_SEAD,		MPROF_STANDARD,	TPROF_FLYBY,	TDESC_ATA,	WP_SEAD,	WP_SEAD,		20,		120,	 40,-60,  0, 2, 10, 40, (uchar)MissionTypeEnum::AMIS_NONE,		1,  0, 0, AMIS_ADDECM | AMIS_HIGHTHREAT | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_OCASTRIKE,	AMIS_TAR_OBJECTIVE,	ARO_S,			MPROF_STANDARD,	TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_STRIKE,		5,		120,	 80,  0,  0, 4, 10, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,255, 0, AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDSEAD | AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_ADDOCASTRIKE | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT },
	{ (uchar)MissionTypeEnum::AMIS_INTSTRIKE,	AMIS_TAR_OBJECTIVE,	ARO_S,			MPROF_STANDARD,	TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_STRIKE,		5,		120,	 50,  0,  0, 4, 10, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,255, 0, AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDSEAD | AMIS_ADDBARCAP | AMIS_ADDOCASTRIKE | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT },
	{ (uchar)MissionTypeEnum::AMIS_STRIKE,		AMIS_TAR_OBJECTIVE,	ARO_S,			MPROF_STANDARD,	TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_STRIKE,		5,		120,	 80,  0,  0, 4, 10, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,255, 0, AMIS_ADDAWACS | AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDSEAD | AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_ADDOCASTRIKE | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT },
	{ (uchar)MissionTypeEnum::AMIS_DEEPSTRIKE,	AMIS_TAR_OBJECTIVE,	ARO_S,			MPROF_STANDARD,	TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_STRIKE,		5,		120,	 80,  0,  0, 4, 10, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,255, 0, AMIS_ADDAWACS | AMIS_ADDECM | AMIS_AVOIDTHREAT | AMIS_HIGHTHREAT | AMIS_ADDSEAD | AMIS_ADDBARCAP | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT },
	{ (uchar)MissionTypeEnum::AMIS_STSTRIKE,	AMIS_TAR_OBJECTIVE,	ARO_S,			MPROF_STANDARD,	TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_STRIKE,		5,		120,	 80,  0,  0, 4, 10, 40, (uchar)MissionTypeEnum::AMIS_NONE,		1,255, VEH_STEALTH, AMIS_AVOIDTHREAT | AMIS_HIGHTHREAT | AMIS_ADDBARCAP | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT },
	{ (uchar)MissionTypeEnum::AMIS_STRATBOMB,	AMIS_TAR_OBJECTIVE,	ARO_SB,			MPROF_HIGH,		TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_BOMB,		200,	600,	300,  0,  0, 2, 10,120, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,255, 0, AMIS_ADDSEAD | AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_ADDOCASTRIKE | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT },
	{ (uchar)MissionTypeEnum::AMIS_FAC,			AMIS_TAR_LOCATION,	ARO_FAC,		MPROF_LOW,		TPROF_LOITER,	TDESC_TAO,	WP_NOTHING,	WP_FAC,			5,		100,	 50,  0, 30, 1,  5, 60, (uchar)MissionTypeEnum::AMIS_SWEEP,	   10, 20, 0, AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_DONT_COORD | AMIS_NPC_ONLY | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_ONCALLCAS,	AMIS_TAR_LOCATION,	ARO_GA,			MPROF_STANDARD,	TPROF_LOITER,	TDESC_TAO,	WP_NOTHING,	WP_CASCP,		2,		100,	 50,  0, 15, 2,  5, 60, (uchar)MissionTypeEnum::AMIS_SWEEP,	   10, 20, 0, AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_ADDFAC | AMIS_ADDBARCAP | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_DONT_COORD | AMIS_NO_BREAKPT | AMIS_EXPECT_DIVERT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_PRPLANCAS,	AMIS_TAR_UNIT,		ARO_GA,			MPROF_STANDARD,	TPROF_TARGET,	TDESC_TAO,	WP_NOTHING,	WP_GNDSTRIKE,	2,		100,	 50,  0,  0, 2,  5, 60, (uchar)MissionTypeEnum::AMIS_SWEEP,	   15, 20, 0, AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_ADDBARCAP | AMIS_NOTHREAT | AMIS_NO_TARGETABORT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_CAS,			AMIS_TAR_LOCATION,	ARO_GA,			MPROF_STANDARD,	TPROF_TARGET,	TDESC_TAO,	WP_NOTHING,	WP_GNDSTRIKE,	2,		100,	 50,  0,  0, 2,  0, 20, (uchar)MissionTypeEnum::AMIS_SWEEP,	    0,  0, 0, AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_IMMEDIATE | AMIS_DONT_COORD | AMIS_ASSIGNED_TAR | AMIS_EXPECT_DIVERT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_SAD,			AMIS_TAR_LOCATION,	ARO_GA,			MPROF_STANDARD,	TPROF_SEARCH,	TDESC_ATA,	WP_SAD,		WP_SAD,			5,		200,	100,  0,  0, 2,  5, 60, (uchar)MissionTypeEnum::AMIS_NONE,	   20, 30, 0, AMIS_ADDAWACS | AMIS_ADDJSTAR | AMIS_ADDBARCAP | AMIS_ADDTANKER | AMIS_DONT_COORD | AMIS_NO_BREAKPT },
	{ (uchar)MissionTypeEnum::AMIS_INT,			AMIS_TAR_LOCATION,	ARO_GA,			MPROF_STANDARD,	TPROF_SEARCH,	TDESC_ATA,	WP_NOTHING,	WP_SAD,			5,		200,	100,  0,  5, 4,  5, 60, (uchar)MissionTypeEnum::AMIS_NONE,		1, 30, 0, AMIS_ADDAWACS | AMIS_ADDJSTAR | AMIS_ADDBARCAP | AMIS_DONT_COORD | AMIS_NO_BREAKPT },
	{ (uchar)MissionTypeEnum::AMIS_BAI,			AMIS_TAR_LOCATION,	ARO_GA,			MPROF_STANDARD,	TPROF_SEARCH,	TDESC_ATA,	WP_NOTHING,	WP_SAD,			5,		200,	100,  0, 15, 4,  0, 60, (uchar)MissionTypeEnum::AMIS_NONE,		1, 30, 0, AMIS_AVOIDTHREAT | AMIS_DONT_COORD | AMIS_NO_BREAKPT },
	{ (uchar)MissionTypeEnum::AMIS_AWACS,		AMIS_TAR_LOCATION,	ARO_AWACS,		MPROF_HIGH,		TPROF_LOITER,	TDESC_TAO,	WP_ELINT,	WP_ELINT,		300,	400,	400,  0,300, 1, 20,120, (uchar)MissionTypeEnum::AMIS_HAVCAP,   50,120, 0, AMIS_ADDESCORT | AMIS_ADDSWEEP | AMIS_NOTHREAT | AMIS_AIR_LAUNCH_OK | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_JSTAR,		AMIS_TAR_LOCATION,	ARO_JSTAR,		MPROF_HIGH,		TPROF_LOITER,	TDESC_TAO,	WP_ELINT,	WP_ELINT,		300,	400,	400,  0,300, 1, 20,120, (uchar)MissionTypeEnum::AMIS_HAVCAP,   50,120, 0, AMIS_ADDESCORT | AMIS_ADDSWEEP | AMIS_NOTHREAT | AMIS_AIR_LAUNCH_OK | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_TANKER,		AMIS_TAR_LOCATION,	ARO_TANK,		MPROF_HIGH,		TPROF_LOITER,	TDESC_TAO,	WP_TANKER,	WP_TANKER,		100,	300,	200,  0,300, 1, 20,120, (uchar)MissionTypeEnum::AMIS_HAVCAP,   40,120, 0, AMIS_ADDESCORT | AMIS_ADDSWEEP | AMIS_NOTHREAT | AMIS_AIR_LAUNCH_OK | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_RECON,		AMIS_TAR_OBJECTIVE,	ARO_REC,		MPROF_LOW,		TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_RECON,		2,		600,	400,  0,  0, 2, 10, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1, 90, 0, AMIS_ADDBARCAP },
	{ (uchar)MissionTypeEnum::AMIS_BDA,			AMIS_TAR_OBJECTIVE,	ARO_REC,		MPROF_STANDARD,	TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_RECON,		2,		200,	100,120,  0, 2, 10, 40, (uchar)MissionTypeEnum::AMIS_NONE,		1,  0, 0, AMIS_AVOIDTHREAT | AMIS_MATCHSPEED | AMIS_NO_DIST_BONUS },
	{ (uchar)MissionTypeEnum::AMIS_ECM,			AMIS_TAR_LOCATION,	ARO_ECM,		MPROF_HIGH,		TPROF_LOITER,	TDESC_TAO,	WP_JAM,		WP_JAM,			100,	500,	200,  0, 60, 1, 10, 60, (uchar)MissionTypeEnum::AMIS_HAVCAP,   30, 60, 0, AMIS_ADDESCORT | AMIS_ADDSWEEP | AMIS_NOTHREAT | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_AIRCAV,		AMIS_TAR_UNIT,		ARO_TACTRANS,	MPROF_LOW,		TPROF_LAND,		TDESC_ATA,	WP_NOTHING,	WP_AIRDROP,		5,		 25,	  5,  0,  2, 4,  5, 40, (uchar)MissionTypeEnum::AMIS_SWEEP,		1,  0, VEH_VTOL, AMIS_AVOIDTHREAT | AMIS_ADDSWEEP | AMIS_ADDESCORT | AMIS_MATCHSPEED | AMIS_DONT_USE_AC | AMIS_FUDGE_RANGE | AMIS_NO_TARGETABORT | AMIS_FLYALWAYS | AMIS_HIGHTHREAT /* KCK: TO ALLOW MORE TO FLY */ },
	{ (uchar)MissionTypeEnum::AMIS_AIRLIFT,		AMIS_TAR_LOCATION,	ARO_TRANS,		MPROF_HIGH,		TPROF_LAND,		TDESC_TTL,	WP_NOTHING,	WP_LAND,		100,	300,	200,  0, 30, 1,  5, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,  0, 0, AMIS_NOTHREAT | AMIS_MATCHSPEED | AMIS_DONT_USE_AC | AMIS_AIR_LAUNCH_OK | AMIS_NO_TARGETABORT | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_SAR,			AMIS_TAR_LOCATION,	ARO_TACTRANS,	MPROF_LOW,		TPROF_TARGET,	TDESC_TAO,	WP_NOTHING,	WP_RESCUE,		1,		 25,	  5,  0,  0, 1,  5, 40, (uchar)MissionTypeEnum::AMIS_RESCAP,	1,  0, VEH_VTOL, AMIS_AVOIDTHREAT | AMIS_HIGHTHREAT | AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_NO_TARGETABORT | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_ASW,			AMIS_TAR_UNIT,		ARO_ASW,		MPROF_LOW,		TPROF_SEARCH,	TDESC_ATA,	WP_ASW,		WP_ASW,			5,		100,	 50,  0,  0, 1,  5, 40, (uchar)MissionTypeEnum::AMIS_SWEEP,	   20,  0, VEH_NAVY, AMIS_ADDSWEEP | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_ASHIP,		AMIS_TAR_UNIT,		ARO_ASHIP,		MPROF_STANDARD,	TPROF_ATTACK,	TDESC_TAO,	WP_NOTHING,	WP_NAVSTRIKE,	5,		100,	 80,  0,  0, 2, 10, 40, (uchar)MissionTypeEnum::AMIS_ESCORT,	1,  0, 0, AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT | AMIS_NO_DIST_BONUS },
	{ (uchar)MissionTypeEnum::AMIS_PATROL,		AMIS_TAR_LOCATION,	ARO_REC,		MPROF_STANDARD,	TPROF_TARGET,	TDESC_ATA,	WP_RECON,	WP_RECON,		100,	500,	 50,  0, 30, 1, 10, 60, (uchar)MissionTypeEnum::AMIS_SWEEP,	   20, 60, VEH_NAVY, AMIS_ADDSWEEP | AMIS_MATCHSPEED | AMIS_NO_DIST_BONUS },
	{ (uchar)MissionTypeEnum::AMIS_RECONPATROL,	AMIS_TAR_LOCATION,	ARO_REC,		MPROF_LOW,		TPROF_LOITER,	TDESC_TAO,	WP_RECON,	WP_RECON,		5,		 25,	  5,  0, 30, 2,  5, 60, (uchar)MissionTypeEnum::AMIS_SWEEP,	   10, 60, VEH_VTOL | VEH_ARMY, AMIS_ADDSWEEP | AMIS_NPC_ONLY | AMIS_DONT_COORD | AMIS_TARGET_ONLY },
	{ (uchar)MissionTypeEnum::AMIS_ABORT,		AMIS_TAR_LOCATION,	0,				MPROF_LOW,		TPROF_TARGET,	TDESC_NONE,	WP_NOTHING,	WP_NOTHING,		5,		500,	100,  0,  0, 0,  0, 60, (uchar)MissionTypeEnum::AMIS_NONE,		0,  0, 0, AMIS_FLYALWAYS },
	{ (uchar)MissionTypeEnum::AMIS_TRAINING,	AMIS_TAR_NONE,		0,				MPROF_STANDARD,	TPROF_ATTACK,	TDESC_NONE,	WP_NOTHING,	WP_NOTHING,		0,		  0,	  0,  0,  0, 0,  0,  0, (uchar)MissionTypeEnum::AMIS_NONE,		0,  0, 0, AMIS_FLYALWAYS } };
...
void SetupAltitudes (Flight flight, MissionRequestClass *mis)
	...
	sRouteAction = MissionData[(uchar)mis->mission].routewp;
	sTargetDesc = MissionData[(uchar)mis->mission].target_desc;

	// Set speeds
	sCruiseSpeed = flight->GetCruiseSpeed();
	sMissionSpeed = flight->GetCombatSpeed();
	if (mis->speed && MissionData[(uchar)mis->mission].flags & AMIS_MATCHSPEED)
		sMissionSpeed = mis->speed;

	// Pick a profile (This could be done as a result of searching for an ingress path)
	if (MissionData[(uchar)mis->mission].mission_profile == MPROF_STANDARD)
		{
		...
		sMissionProfile = MissionData[(uchar)mis->mission].mission_profile;

	// Choose an altitude at our target
	minAlt = MissionData[(uchar)mis->mission].minalt*100;		// Minimum altitude at target
	maxAlt = MissionData[(uchar)mis->mission].maxalt*100;		// Maximum altitude at target
	...
	if (sMissionProfile == MPROF_LOW)
		...
		sTargetAlt = MissionData[(uchar)mis->mission].missionalt*100;
	if (sTargetAlt < minAlt)
		sTargetAlt = minAlt;
	if (sTargetAlt > maxAlt)
		sTargetAlt = maxAlt;
	if (MissionData[(uchar)mis->mission].target_profile != TPROF_FLYBY && MissionData[(uchar)mis->mission].target_profile != TPROF_NONE)
		{
		// Find a target alt based on threat as well
		sTargetAlt = (sTargetAlt + MissionData[(uchar)mis->mission].missionalt*100)/2;
	...
	if (dtt < MIN_DIST_FOR_INGRESS || DistanceToFront(mis->tx,mis->ty) < MIN_DIST_FOR_INGRESS/2)
		...
		sMissionAlt = MissionData[(uchar)mis->mission].missionalt*100;
...
int BuildPathToTarget (Flight u, MissionRequestClass *mis, VU_ID airbaseID)
	...
	if (!(MissionData[(uchar)mis->mission].flags & AMIS_TARGET_ONLY))
		{
		if (mis->mission == MissionTypeEnum::AMIS_AIRCAV)
			{
			...
			if (!u)
				return 0;
			u->GetLocation(&x,&y);
			nw = new WayPointClass(x, y, 0, 0, 0, MissionData[(uchar)mis->mission].loitertime*CampaignMinutes, WP_PICKUP, WPF_LAND);
			nw->SetWPTarget(u->Id());
			FinalizeWayPoint(nw);
			cw->InsertWP(nw);
			cw = nw;
...
//			cw = nw;
	...
	switch (MissionData[(uchar)mis->mission].target_profile)
		{
		case TPROF_ATTACK:
...
void BuildDivertPath (Flight flight, MissionRequestClass *mis)
	...
	tw->SetWPAltitude(MissionData[(uchar)mis->mission].missionalt*100);//Cobra they forgot *100 ;)
	...
	if (w->GetWPAction() == WP_TAKEOFF || !w->GetPrevWP())
		...
		if (MissionData[(uchar)mis->mission].flags & AMIS_ASSIGNED_TAR)
			{
			...
			nw->InsertWP(tw);
			tw->InsertWP(cw);
			tw->SetWPAltitude(MissionData[(uchar)mis->mission].missionalt);
			}
		flight->GetLocation(&x,&y);
...
WayPoint SetupIngressPoints(WayPoint cw, Flight u, MissionRequestClass *mis)
	...
	if (!(MissionData[(uchar)mis->mission].flags & AMIS_NO_BREAKPT))
		{
...
WayPoint AddIngressPath(WayPoint cw, Flight u, MissionRequestClass *mis)
	...
	cw->InsertWP(nw);
	if (MissionData[(uchar)mis->mission].flags & AMIS_DONT_COORD)
		{
...
WayPoint AddAttackProfile(WayPoint cw, Flight u, MissionRequestClass *mis)
	...
	// Add the target WP
	tw = new WayPointClass(mis->tx, mis->ty, 0, 0, 0, 0, MissionData[(uchar)mis->mission].targetwp, WPF_TARGET);
	cw->InsertWP(tw);
...
WayPoint AddLoiterProfile(WayPoint cw, Flight u, MissionRequestClass *mis)
	...
	// The Target Location
	tw = new WayPointClass(mis->tx, mis->ty, 0, 0, 0, 0, MissionData[(uchar)mis->mission].targetwp, WPF_TARGET | WPF_CP);
	tw->SetWPTarget(mis->targetID);
	tw->SetWPTargetBuilding((uchar)mis->target_num);
	FinalizeWayPoint(tw);
	cw->InsertWP(tw);
	...
	if (mis->mission == MissionTypeEnum::AMIS_FAC)
		r += PI;
	...
	lw = new WayPointClass(lx, ly, 0, 0, 0, MissionData[(uchar)mis->mission].loitertime*CampaignMinutes, MissionData[(uchar)mis->mission].targetwp, WPF_TARGET | WPF_CP | WPF_REPEAT);
	FinalizeWayPoint(lw);
	cw->InsertWP(lw);
	cw = lw;
...
WayPoint AddSweepProfile(WayPoint cw, Flight u, MissionRequestClass *mis)
	...
	for (s=0; s<3; s++)
		{
		bs = 9999;
		sw = new WayPointClass(0, 0, 0, 0, 0, 0, MissionData[(uchar)mis->mission].targetwp, WPF_TARGET);
...
WayPoint AddLandProfile(WayPoint cw, Flight u, MissionRequestClass *mis)
	...
	tw = new WayPointClass(mis->tx, mis->ty, 0, 0, 0, MissionData[(uchar)mis->mission].loitertime*CampaignMinutes, MissionData[(uchar)mis->mission].targetwp, WPF_TARGET | WPF_LAND | WPF_TAKEOFF);
	tw->SetWPTarget(mis->targetID);
	tw->SetWPTargetBuilding((uchar)mis->target_num);
	FinalizeWayPoint(tw);
	if (cw)
...
void AddInformationWPs (Flight flight, MissionRequestClass *mis)
	...
	if (flight->GetUnitMission() != MissionTypeEnum::AMIS_TANKER)
		{
...
//TJL 11/22/03 More division by 2 removal. Errors are now aircraft specific.
	...
	offset = MissionData[(uchar)u->GetUnitMission()].separation*CampaignSeconds;
...
//	al = GetAltitudeLevel(sCurrentAlt);
	...
	xd = yd = 0.0;
	//RERUN ShiAssert(d); // seems to happen
	if (d)
	{
		xd = (float)(x2-x1)/d;
		yd = (float)(y2-y1)/d;
...
int TargetThreats (Team team, int priority, F4PFList list, MoveType mt, CampaignTime time, long target_flags, short* targeted)
{
	...
	MissionTypeEnum strike_type = MissionTypeEnum::AMIS_SEADSTRIKE;
	GridIndex			x,y;
	MissionRequestClass	mis;
	...
	while (e)
	{
		...
		if (e->GetAproxCombatStrength(mt,0) > 0)						// This unit can hurt us
		{
			...
			if (e->IsUnit() && e->GetSType() == STYPE_UNIT_AIR_DEFENSE && (e->GetSpotted(team) || rand() < HALF_CHANCE))
			{
				...
				strike_type = MissionTypeEnum::AMIS_SEADSTRIKE;
		...
		else if (e->GetDetectionRange(mt) > VisualDetectionRange[mt])	// This unit has radar
		{
			...
			if (e->IsObjective())
			{
				strike_type = MissionTypeEnum::AMIS_OCASTRIKE;
